...
Para poder usar la librería CrazyLink en un proyecto Pycharm es necesario copiar la carpeta CrazyLink que hay en este repositorio en la carpeta del proyecto en el que se quiere usar. Para ello basta clonar este repositorio y luego copiar la carpeta CrazylinkLink (y posiblemente borrar después el repositorio clonado).
...
Una vez con las librerías instaladas y nuestro proyecto de PyCharm creado, podremos ejecutar el comando cfclient en la consola del proyecto para hacer las primeras pruebas de vuelo des de la interfaz ofrecida por Bitcraze.
